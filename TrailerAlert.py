...
if __name__ == '__main__':
    ...
    for index, row in vehicles.iterrows():
        ...
        # We currently do not capture these values, but may in the future.
    ...
    # value. We can assume that a healthy vehicle will report at least once every 24 hours
